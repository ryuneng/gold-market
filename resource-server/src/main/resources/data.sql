...
VALUES
    ...
    (100001, 'PURCHASE-20240910-100001', 2, 3, 3.75, 1347108, 'ORDER_PLACED', '경기도 성남시 분당구 금곡로 302', '2024-09-10 12:00:00', '2024-09-10 12:00:00', false);

# 판매 주문
INSERT INTO orders
(id, order_number, user_id, product_id, quantity, total_price, status, created_at, updated_at, is_deleted)
VALUES
    (100002, 'SALE-20240909-100002', 3, 2, 3.75, 222108, 'RECEIVED', '2024-09-09 12:00:00', '2024-09-09 12:00:00', false),
    (100003, 'SALE-20240910-100003', 4, 4, 3.75, 972108, 'ORDER_PLACED', '2024-09-10 12:00:00', '2024-09-10 12:00:00', false);
